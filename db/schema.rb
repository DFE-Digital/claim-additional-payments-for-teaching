...
ActiveRecord::Schema.define(version: 2023_01_13_150436) do
  ...
  create_table "claims_payments", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "claim_id"
    t.uuid "payment_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["claim_id", "payment_id"], name: "index_claims_payments_on_claim_id_and_payment_id", unique: true
    t.index ["claim_id"], name: "index_claims_payments_on_claim_id"
    t.index ["payment_id"], name: "index_claims_payments_on_payment_id"
  end
  ...
  add_foreign_key "claims_payments", "claims"
  add_foreign_key "claims_payments", "payments"

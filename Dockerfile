...
RUN apk add pcre2=~10.46-r0 # force vulnerability fix
RUN apk add postgresql16=~16.11-r0
...
RUN DFE_SIGN_IN_API_CLIENT_ID= \
  ...
  DFE_SIGN_IN_INTERNAL_CLIENT_ID= \
  DFE_SIGN_IN_INTERNAL_CLIENT_SECRET= \
  DFE_SIGN_IN_INTERNAL_API_SECRET= \
  ENVIRONMENT_NAME= \

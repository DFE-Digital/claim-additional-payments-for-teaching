    ...
    RSpec.describe StudentLoanAmount do
      ...
      describe "#perform" do
        ...
        context "when the claim policy is TSLR" do
          let(:claim) { create(:claim, :submitted, policy:, national_insurance_number: "AB123456A", has_student_loan: true, student_loan_plan: claim_student_loan_plan, eligibility:, award_amount: claim_student_loan_repayment_amount) }
          let(:eligibility) { create(:student_loans_eligibility) }

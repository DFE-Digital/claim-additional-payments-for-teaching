...
RSpec.describe Policies::DataRetention::EvaluationContext do
  ...
  describe "#submitted_in_previous_academic_term?" do
    subject { evaluation_context.submitted_in_previous_academic_term? }
  ...
  describe "#inactive_claim_submitted_in_previous_academic_term?" do
    subject { evaluation_context.inactive_claim_submitted_in_previous_academic_term? }

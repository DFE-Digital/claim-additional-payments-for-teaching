...
RSpec.describe Policies::LevellingUpPremiumPayments::Award do
  describe ".csv_for_academic_year" do
    ...
    before { create(:levelling_up_premium_payments_award, academic_year: academic_year - 1) }
  ...
  describe ".distinct_academic_years" do
    ...
    context "when there are awards" do
      before do
        create(:levelling_up_premium_payments_award, academic_year: academic_year)
        create(:levelling_up_premium_payments_award, academic_year: academic_year)
        create(:levelling_up_premium_payments_award, academic_year: academic_year - 1)
        create(:levelling_up_premium_payments_award, academic_year: academic_year - 1)
      end

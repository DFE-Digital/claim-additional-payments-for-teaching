...
RSpec.describe StudentLoansClaimsCsv do
  before do
  ...
  describe "file" do
    ...
    it "returns the correct rows" do
      expect(csv[1]).to eq([
        ...
        eligibility.biology_taught? ? "Yes" : "No",
        eligibility.chemistry_taught? ? "Yes" : "No",
        eligibility.computer_science_taught? ? "Yes" : "No",
        eligibility.languages_taught? ? "Yes" : "No",
        eligibility.physics_taught? ? "Yes" : "No",

FactoryBot.define do
  factory :teachers_pensions_service do
    trait :targeted_retention_incentive_payments_matched_first do
    ...
    trait :targeted_retention_incentive_payments_matched_second do
      teacher_reference_number { 1334425 }
      la_urn { 370 }
      school_urn { 8091 }
    ...
    trait :targeted_retention_incentive_payments_matched_third do
      teacher_reference_number { 1334425 }
      la_urn { 370 }
      school_urn { 8091 }
    ...
    trait :targeted_retention_incentive_payments_unmatched_unmatched_jan_2022 do
      teacher_reference_number { 1334425 }
      la_urn { 383 }
      school_urn { 4026 }
      start_date { DateTime.new(2022, 1, 1, 16, 0, 0) }
    ...
    trait :targeted_retention_incentive_payments_unmatched_december_2021 do
      teacher_reference_number { 1334425 }
      la_urn { 383 }
      school_urn { 4026 }
      start_date { DateTime.new(2021, 12, 1, 16, 0, 0) }

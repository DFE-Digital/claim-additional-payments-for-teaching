module FeatureHelpers
  ...
  def upload_employment_proof
    # Upload a file then reject it on review
    expect(page).to have_text("Upload your payslip")
    ...
    # Back to upload — attach a different file and confirm it
    expect(page).to have_text("Upload your payslip")
    ...
    expect(page).to have_text("Document uploaded successfully")
  end

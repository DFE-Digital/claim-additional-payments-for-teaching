...
RSpec.shared_examples "Admin Checks" do |policy|
  ...
  def fe_claim_checking_steps
    ...
    expect(page).to have_link("Next:Previous claim mismatch")
    expect(page).not_to have_link("Previous", exact: true)
    ...
    expect(page).to have_link("Next:Student loan plan")
    expect(page).to have_link("Previous:Previous claim mismatch")

RSpec.shared_examples "Admin View Claim Feature" do |policy|
  ...
  def expect_page_to_have_policy_sections(policy)
    ...
    when Policies::InternationalRelocationPayments
      ["First year payment", "Identity confirmation", "Visa", "Arrival date", "Previous residency", "Employment", "Employment contract", "Employment start", "Subject", "Teaching hours", "Decision"]
    ...
    when Policies::EarlyYearsPayments
      ["Identity confirmation", "Employment", "Student loan plan", "Decision"]
    else

...
RSpec.feature "Payroll" do
  ...
  scenario "Service operator creates a payroll run" do
    ...
    travel_to 2.months.ago do
      lup_eligibility = create(:targeted_retention_incentive_payments_eligibility, :eligible, award_amount: 1500.0)
      paid_lup_claim = create(:claim, :approved, policy: Policies::TargetedRetentionIncentivePayments, eligibility: lup_eligibility)

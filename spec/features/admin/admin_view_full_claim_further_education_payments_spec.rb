    ...
    it "shows the full claim details" do
      ...
      expect(
        summary_row(
          ...
          "Springfield Elementary during the spring term?"
        )
      ).to have_content("12 or more hours per week, but fewer than 20")

      expect(
        summary_row(
          "Which academic year did you start your further education (FE) " \
      ...
      expect(
        summary_row(
          "Are you currently subject to any formal performance measures as a result of " \

...
RSpec.feature "Ineligible targeted_retention_incentive payments claims" do
  let(:eligibility) { Policies::TargetedRetentionIncentivePayments::Eligibility.order(:created_at).last }
  ...
  scenario "When the school selected is Targeted Retention Incentive ineligible" do
    school = create(:school, :early_career_payments_eligible, :targeted_retention_incentive_payments_ineligible)
  ...
  scenario "When the school selected is both ECP and Targeted Retention Incentive ineligible" do
    school = create(:school, :early_career_payments_ineligible, :targeted_retention_incentive_payments_ineligible)
    start_targeted_retention_incentive_payments_claim
  ...
  def eligibility_checker(journey_session)
    Policies::TargetedRetentionIncentivePayments::PolicyEligibilityChecker.new(

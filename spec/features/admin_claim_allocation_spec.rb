  ...
  context "with more than 25 claims" do
    scenario "assign first 25 to one Claim's checker" do
      ...
      within("#allocations") do
        ...
        expect(page).to have_select("allocate_to_policy", options: ["All", "Student Loans", "Maths and Physics", "Early-Career Payments", "Levelling Up Premium Payments", "Simple Policy Payments"])

...
RSpec.feature "Provider verifying claims", feature_flag: :provider_dashboard do
  scenario "with custom subjects and courses" do
    ...
    expect(summary_row("Subject areas")).to have_content("Building and construction, Chemistry, Computing, including digital and ICT, Early years, Engineering and manufacturing, including transport engineering and electronics, Maths and Physics")

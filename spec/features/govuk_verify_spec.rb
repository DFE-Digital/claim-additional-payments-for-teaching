...
RSpec.feature "Teacher verifies identity using GOV.UK Verify" do
  ...
  context "cancelled response" do
    ...
    scenario "shows the no_authentication error", js: true do
      ...
      expect(page).to have_text(I18n.t("verify.errors.no_authentication.title"))
      expect(page).to have_text(I18n.t("verify.errors.no_authentication.description"))
    end
  end
  ...
  context "failed response" do
    ...
    scenario "shows the failed error", js: true do
      ...
      expect(page).to have_text(I18n.t("verify.errors.authentication_failed.title"))
      expect(page).to have_text(I18n.t("verify.errors.authentication_failed.description"))
    end
  end
end

    ...
    context "when a claim is already in progress" do
      ...
      context "when the user has completed the journey in the correct slug sequence" do
        ...
        it "resets dependent claim attributes when appropriate" do
          ...
          put claim_path(StudentLoans.routing_name, "provide-mobile-number"), params: {claim: {provide_mobile_number: true}}

          expect(response).to redirect_to(claim_path(StudentLoans.routing_name, "mobile-number"))

class NqtInAcademicYearAfterIttForm < Form
  ...
  # We can't just update the eligibility's qualification as there's dependent
  # answers that need reseting, so we go through the qualification form to make
  # sure that's all handled in one place

      ...
      module Verification
        class ClaimantPersonalDetailsForm < BaseForm
          ...
          validates(
            ...
            presence: {
              message: "Enter a real postcode, for example NE1 6EE"
            }
          )
          ...
          validates(
            ...
            inclusion: {
              ...
              message: ->(form, _) do
                "Tell us if these bank details match what you have for #{form.claimant_name}?"
              end
            }
          )
          ...
          def date_of_birth_criteria
            if date_parts.all?(&:blank?)
              errors.add(
                ...
                "Enter #{claimant_name}’s date of birth"
              )

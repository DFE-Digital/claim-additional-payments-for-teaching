module Admin
  module Claims
    class CreateEmploymentHistoryForm
      ...
      validates :school_id, presence: {message: "Select a previous workplace"}
      ...
      def save
        ...
        employment = claim.policy::EmploymentHistory.new(
          school: school,
        ...
        histroy = Array.new(eligibility.employment_histories) << employment

        eligibility.employment_histories = histroy

class Admin::SchoolWorkforceCensusForm
  ...
  validates :file,
    presence: {message: "Choose a CSV file of School Workforce Census data to upload"}
  ...
  def importer
    @importer ||= SchoolWorkforceCensusDataImporter.new(file)
  end

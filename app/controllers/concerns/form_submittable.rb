module FormSubmittable
  ...
  included do
    ...
    def redirect_to_slug(slug, query_parameters: request.query_parameters)
      ...
      redirect_to send(:"#{path_helper_resource}_path", current_journey_routing_name, slug, query_parameters)
    end

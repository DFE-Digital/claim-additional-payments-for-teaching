  ...
  class QualificationReportUploadsController < BaseAdminController
    ...
    def create
      ...
      if @upload_form.invalid?
        ...
        flash[:notice] = "DQT report uploaded successfully. Automatically completed #{pluralize(@dqt_report_consumer.completed_tasks, "task")} for #{pluralize(@dqt_report_consumer.total_claims_checked, "checked claim")}."

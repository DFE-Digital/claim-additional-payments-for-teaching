...
module Irp
  class ApplicationController < ActionController::Base
    ...
    def check_whether_closed_for_submissions
      irp_policy_configuration = PolicyConfiguration.for(Irp)
      unless irp_policy_configuration.open_for_submissions?
        @availability_message = irp_policy_configuration.availability_message

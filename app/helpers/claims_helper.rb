module ClaimsHelper
  ...
  def student_loan_answers(claim)
    [].tap do |a|
      ...
      a << [translate("questions.postgraduate_masters_loan"), (claim.postgraduate_masters_loan ? "Yes" : "No"), "masters-loan"] if (claim.has_ecp_policy? || claim.policy == StudentLoans) && claim.has_student_loan?
      a << [translate("questions.postgraduate_doctoral_loan"), (claim.postgraduate_doctoral_loan ? "Yes" : "No"), "doctoral-loan"] if (claim.has_ecp_policy? || claim.policy == StudentLoans) && claim.has_student_loan?
    end
  end

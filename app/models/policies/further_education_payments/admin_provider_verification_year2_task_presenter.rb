module Policies
  module FurtherEducationPayments
    # Presenter for Year 2+ (2025/2026 onwards) FE provider verification tasks
    # This presenter includes all the Year 2 specific fields like teaching qualification,
    # contract type, teaching hours, performance measures, and disciplinary action.
    class AdminProviderVerificationYear2TaskPresenter
      ...
      # Year 2 assertions with all new fields
      def assertions

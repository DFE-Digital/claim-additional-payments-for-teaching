    ...
    class SlugSequence
      ...
      def slugs
        SLUGS.dup.tap do |sequence|
          ...
          sequence.delete("personal-bank-account") if answers.bank_or_building_society == "building_society"
          sequence.delete("building-society-account") if answers.bank_or_building_society == "personal_bank_account"

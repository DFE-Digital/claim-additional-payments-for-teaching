module TeacherAuth
  class SchoolConfig
    ...
    def callback_path
      @callback_path ||= "#{path_prefix}/teacher_school/callback"
    end

    def path_prefix
      @path_prefix ||= "/targeted-retention-incentive-payments/auth"
    end
    ...
    def identifier
      ENV["TEACHER_AUTH_SCHOOL_CLIENT_ID"]
    end

    def secret
      ENV["TEACHER_AUTH_SCHOOL_SECRET"]
    end
  end
end

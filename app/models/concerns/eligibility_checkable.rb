module EligibilityCheckable
  ...
  FIRST_COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEAR = AcademicYear.new(2022)
  FINAL_COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEAR = AcademicYear.new(2024)
  COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEARS = FIRST_COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEAR..FINAL_COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEAR
  COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEARS_BEFORE_FINAL_YEAR = FIRST_COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEAR...FINAL_COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEAR
  ...
  def any_future_combined_policy_years?
    claim_year < FINAL_COMBINED_ECP_AND_TARGETED_RETENTION_INCENTIVE_POLICY_YEAR
  end
end

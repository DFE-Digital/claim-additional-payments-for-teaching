class JourneyFlowDefinition
  ...
  class << self
    ...
    def svg_for(journey_id)
      ...
      lines = []
      lines << "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 #{width} #{height}\" width=\"#{width}\" height=\"#{height}\" role=\"img\" aria-label=\"Journey flow diagram\" class=\"journey-flow-svg\">"

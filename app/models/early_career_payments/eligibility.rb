module EarlyCareerPayments
  class Eligibility < ApplicationRecord
    ...
    def ineligible_cohort?
      ...
      }.find do |eligible_cohort_itt_subject, eligible_cohort_itt_academic_years|
        eligible_cohort_itt_subject.to_s == eligible_itt_subject && eligible_cohort_itt_academic_years.any?(itt_academic_year)
      end

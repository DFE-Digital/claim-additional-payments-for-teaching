...
class Claim < ApplicationRecord
  ...
  validates :postgraduate_masters_loan, on: [:"masters-loan", :submit], inclusion: {in: [true, false], message: "Select yes if you have a Postgraduate Master Loan taken out on or after 1st August 2016"}, if: -> { has_student_loan? && (has_ecp_policy? || policy == StudentLoans) }
  validates :postgraduate_doctoral_loan, on: [:"doctoral-loan", :submit], inclusion: {in: [true, false], message: "Select yes if you have a Postgraduate Doctoral Loan taken out on or after 1st August 2018"}, if: -> { has_student_loan? && (has_ecp_policy? || policy == StudentLoans) }
